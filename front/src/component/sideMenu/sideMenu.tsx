...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Estoque', icon: FiTrendingUp, path: '/dashboard/estoque' },
  { name: 'Catálogo', icon: FiShoppingBag, path: '/dashboard/catalogo' },
  { name: 'Checkout', icon: FiShoppingCart, path: '/dashboard/checkout' },
]
